    ...
    return (
        <>
            <div className="sm:w-60">
                <h1 className="flex justify-center sm:justify-start font-bold text-xl font-serif py-1">
                    Six Days In Dubai
                </h1>
                <ul className="flex sm:flex-col justify-center items-center sm:items-start">
